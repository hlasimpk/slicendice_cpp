...
# center_half_distances = center_distances / 2

# print('Center half distances:')
# print(center_half_distances)


# partition_output = np.partition(np.asarray(center_half_distances), kth=1, axis=0)
# distance_next_center =  partition_output[1]

# print('Partition output:')
# print(partition_output)

# print('Distance to next center:')
# print(distance_next_center)

start_time = time.time()
kmeans = KMeans(n_clusters=8, algorithm='full')
kmeans.fit(X)
end_time = time.time()
...
print("Time taken for KMeans (microseconds): ", ((end_time - start_time) * 1e6) )
...
# centers_init = _kmeans_plus_plus(X, 8, None, None, None, None)[0]
...
# print(centers)
# center_half_distances = _euclidean_distances(X, X) / 2
